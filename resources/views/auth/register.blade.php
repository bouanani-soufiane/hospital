    ...
    <form method="POST" action="{{ route('register') }}" id="registrationForm" >
        ...
        <div class="mt-4 flex space-x-8 items-center">
            ...
            <label class="inline-flex space-x-3 items-center">
                <span class="ml-2"><i class="fas fa-user-md text-md text-blue-500"></i></span>
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300 ml-1 mr-1">Doctor</span>
                <input type="radio" class="form-radio text-blue-500" value="doctor" name="role" onchange="toggleSpecialties()">
            </label>

            <!-- Patient Role -->
            <label class="inline-flex space-x-3 items-center">
                <span class="ml-2 text-md ml-3 text-red-500"><i class="fas fa-user-injured "></i></span>
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300 ml-1 mr-1">Patient</span>
        ...
        <div id="birthday" class="mt-4 hidden">
            <label for="birthday" :value="__('Birthday')"  class="block text-sm font-medium text-white">Birthday</label>
